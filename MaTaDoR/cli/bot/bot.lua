...
chats = {}
plugins = {}
MaTaDoR_sudo = 371778875 -- ایدی سودوی اصلی را قرار دهید
GpsidSudo = -1001137329081
bot_id = 495333393 -- ایدی ربات را قرار دهید
helper_id = 517281690 -- ایدی ربات api را قرار دهید
MaTaDoRch = '@TrillAssNiggas' -- یوزرنیم کانال خود را قرار دهید
MaTaDoRby = '@PutOut' -- یوزرنیم خود را قرار دهید
MaTaDoRbybot = '@PutOut_Bot'  -- یوزرنیم پیام رسان خود را قرار دهید
paypinglink = 'Mhnsb' -- لینک payping  خود را قرار دهید
paypingname = 'MhmdH' -- اسم خود را وارد نماید
