...
bot_token = "517281690:AAGZc-qOUwpHYHM0grsq9Ij7YT52JI4NVE0" -- در اینجا توکن ربات api  را قرار دهید
send_api = "https://api.telegram.org/bot"..bot_token
sudo_id = 371778875 -- ایدی سودوی اصلی را قرار دهید
...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {371778875,495333393,}, -- در اینجا آیدی ربات api و cli  و سودو ها را وارد کنید
    admins = {},
    disabled_channels = {},
